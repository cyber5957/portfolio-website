...
- `client/app` - Next.js App Router pages and layout
- `client/components` - Reusable portfolio sections and UI pieces
- `client/data` - Portfolio content and copy
- `server` - Legacy Express API from the earlier MERN version
